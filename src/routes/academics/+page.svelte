<script lang="ts">
  ...
  $: prevIndex = (currentIndex - 1 + slides.length) % slides.length;
...
<main class="flex flex-col min-h-screen">
            ...
            <div class="grid gap-5 py-4 mt-5">
              ...
              <div>
                ...
                >
                  ...
                  >
                  <Label for="name" class="text-right text-md">Admission</Label>
                </a>
              </div>
              <div>
                <a
  ...
  <div class="min-h-screen bg-white mt-20 lg:mt-32">
    <!-- Hero Section -->

    <div class="container mx-auto px-4 mt-5 hidden lg:block">
      <h1 class="text-4xl font-bold">Congratulations, students.</h1>
    </div>
    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-col lg:flex-row gap-8">
        <!-- Left Content -->
        <div class="flex-1">
          <h2 class="text-2xl font-bold mb-4">WELCOME TO THE</h2>
          <h3 class="text-3xl font-bold mb-6">FACULTY OF COMPUTING</h3>

          <p class="text-gray-700 mb-8">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere
            nisi perspiciatis rem optio ipsum eaque commodi quasi laudantium?
          ...
          <div class="mb-8">
            <h4 class="font-bold mb-4">ACCESS YOUR STUDENT'S PORTAL</h4>
            <p class="text-gray-700 mb-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iste
              quidem explicabo molestiae, repellat corporis ex fugit!
              Necessitatibus, officiis impedit?
            </p>
            <Button
              variant="outline"
              class="w-fit text-green-600 hover:bg-green-600 hover:text-white group inline-flex items-center"
              >ARIS STUDENT'S PORTAL {" "}
              <ChevronRightIcon
        ...
        <div class="flex-1">
          <div
            class="bg-green-600 text-white py-8 w-2/5 h-80 absolute right-0 top-10 z-10 hidden lg:block"
          ></div>
      ...
      <div class="flex flex-col md:flex-row gap-8 my-12">
        ...
        <div class="flex-1">
          <img
            src="https://i.pinimg.com/736x/98/e0/cf/98e0cfa8e1b9b156f633a0ee7f5a4981.jpg?enhanced"
            alt="New Student Orientation"
            class="w-full lg:w-2/3 h-64 object-cover rounded-lg mb-4"
          />
          <h3 class="text-xl font-bold mb-4">New Student Orientation</h3>
          <p class="text-gray-700 mb-4">
        ...
        <div class="flex-1">
          <img
            src="https://i.pinimg.com/736x/72/4a/76/724a765b761ff97c770e49e0ae3c909a.jpg?enhanced"
          ...
          <p class="text-gray-700 mb-4">
            ...
            iure voluptates nesciunt porro. Distinctio itaque, optio sed
            repellendus nostrum molestias eligendi earum expedita iste nisi
            incidunt omnis ut quisquam ratione eveniet quaerat quas
            perspiciatis. Magni ad neque esse earum veritatis repellat
            blanditiis temporibus iste, sunt magnam. Corrupti necessitatibus
            temporibus placeat.
          </p>
          <a href="/contact">
            <Button
  ...
  <h1 class="text-4xl font-bold my-10 lg:ms-64 text-center lg:text-left">
    FACULTY INFRASTRUCTURE
  </h1>
  <div class="relative">
    <div
      class=" absolute top-0 left-0 w-3/5 h-48 bg-green-600 hidden lg:block"
    ></div>
    <div class="relative w-full overflow lg:mt-24">
      <div class="flex items-center justify-center h-[600px]">
        <!-- Previous Slide -->
        <div
          class="w-4 h-[60vh] md:w-20 md:h-[45vh] lg:w-1/4 lg:h-full overflow-hidden"
        >
          <img
        ...
        <!-- Current Slide -->
        <Card
          class="w-full lg:w-1/2 h-full relative z-10 shadow-xl border-none -top-5"
        >
          <img
            src={slides[currentIndex].image}
            alt={slides[currentIndex].title}
            class="w-full h-full object-cove rounded-t-sm"
          />
          <div
            class="absolute -bottom-20 left-0 right-0 bg-white rounded-b-sm border border-opacity-50 p-8 flex flex-col gap-2"
          >
          ...
          <Button
            variant="destructive"
            class="absolute left-0 top-1/2 -translate-y-1/2 h-12 w-12 bg-green-600 hover:bg-green-500 rounded-none"
            on:click={prev}
          >
          ...
          <Button
            variant="destructive"
            class="absolute right-0 top-1/2 -translate-y-1/2 h-12 w-12 bg-green-600 hover:bg-green-500 rounded-none"
            on:click={next}
          >
  ...
  <!-- Call to Action -->
  <div class="text-center py-12 px-3 md:px-0 mt-20">
    <h2 class="text-3xl font-bold text-green-600 mb-4">
      Ready to take the next step?
    </h2>
    <p class="text-gray-700 mb-6">
      Learn more about the staffs and execuive team of the Faculty of Computing.
    </p>
    <a href="">
      <Button
      variant="outline"
